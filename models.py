...
class DIGNN_Neural_Simplified(nn.Module):
    def __init__(self,
                 in_channels: int,
                 out_channels: int,
                 hidden_channels: int,
                 ...
                 preprocess: str='linkx',
                 **kwargs):
        super(DIGNN_Neural_Simplified, self).__init__()
        ...
        self.model = ImplicitFunc_Neural_Simplified(hidden_channels, hidden_channels, mu)
...
class DIGNN_Neural_Simplified_L1(nn.Module):
    def __init__(self,
                 in_channels: int,
                 out_channels: int,
                 hidden_channels: int,
                 ...
                 preprocess: str='linkx',
                 **kwargs):
        super(DIGNN_Neural_Simplified_L1, self).__init__()
        ...
        self.model = ImplicitFunc_Neural_Simplified_L1(hidden_channels, hidden_channels, rho, lbd, mu_k_max, mu_k, K_iter)
